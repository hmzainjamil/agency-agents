...
| Concept | Description |
|---|---|
| **Agency** | Core concept — primary building block of agency agents |
| **Agents** | Execution primitive handling agents operations |
| **Ai** | Integration layer for AI connectivity |
| **Digital** | Configuration and routing for digital behavior |
...
```bash
# Clone and explore
gh repo clone hmzainjamil/agency-agents
cd agency-agents

# Load as Claude Code skill
cp -r . ~/.claude/skills/agency-agents/

# Run via MAE pipeline
mae run "agency agents - primary workflow"
...
- **Freelancers** — use as billable-hours accelerator for agency + agents work
...
[![Star History Chart](https://api.star-history.com/svg?repos=hmzainjamil/agency-agents&type=Date)](https://star-history.com/#hmzainjamil/agency-agents&Date)
